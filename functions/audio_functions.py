...
def generate_mel_spectrogram(data, rate, n_mels, window, fft_win , fft_hop, f_max, f_min=0):
...
def generate_stretched_mel_spectrogram(data, sr, duration, n_mels, window, fft_win , fft_hop, MAX_DURATION):
    ...
    D_stretched = librosa.core.phase_vocoder(D, rate=stretch_rate, hop_length=hop_length) 
